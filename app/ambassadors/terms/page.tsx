...
const CLAUSES: { n: string; title: string; body: string[] }[] = [
  ...
  {
    n: "02",
    title: "What we ask, and the monthly tub",
    body: [
      "As an ambassador you agree to two things: to mention REKRD in a story or a post once or twice a week and tag us, and to say in your profile bio that you are a REKRD ambassador, with your link.",
      "In return we send you one 30-sachet tub a month, free, to the delivery address you gave us. There is no charge and no minimum spend. The tub is sponsorship for the posting, not payment for sales.",
      "If the posting stops, the tub stops. We will ask you first rather than simply cancelling, and you can pick it up again whenever you like. Nothing about this affects your discount code or any commission you have already earned.",
      "You accept these when you tick them on the signup form. We record which version of the wording you accepted and when, and email you a copy of it — keep that email, it is your record as much as ours.",
    ],
  },
  {
    n: "03",
  ...
  },
  {
    ...
    body: [
      ...
      "Do not recruit other ambassadors for a share of their commission. This is not a multi-level scheme and we will not build one.",
  ...
  },
  {
    ...
    body: [
      "We collect your name, email, mobile number, town, what your world is and, optionally, your gym and Instagram handle. We use it to run the programme, pay you and send you programme information. Our lawful basis is the performance of this agreement, under section 11(1)(b) of POPIA — not consent.",
      "Marketing email is separate and optional, and you can stop it at any time without affecting your code or your commission.",
      "We do not share your clients' identities with you, and we do not share your details with other ambassadors. Your dashboard shows order numbers, values and commission — never a customer's name, email or address.",
      "Our systems are hosted outside South Africa by providers bound by data protection agreements. We keep ambassador and payment records for five years, as tax law requires.",
  ...
  },
  {
    ...
    body: [
      ...
      "We may close your code if you break the rules on talking about the product in clause 06, do any of the things in clause 07, or if the programme ends. Except in the case of a serious claims breach, we will tell you first, and you will still be paid what you have already earned.",
      ...
      <section className="section">
        <div className="wrap">
          ...
          <p style={{ marginTop: 26 }}>
            <a className="btn ghost" href="/ambassadors">
