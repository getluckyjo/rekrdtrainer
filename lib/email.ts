...
export async function sendWelcomeEmail(opts: {
  ...
  await resend.emails.send({
    ...
    text: [
      ...
      `2. Say what's in the sachet — 600mg of sodium, 500mg of L-glutamine,`,
      `   zinc and vitamin C, no sugar, no fillers. That's the whole story and`,
      `   it's all safe to say. Just don't tell people what it does to a body.`,
      `   Unsure about a line? Ask us — nobody has ever been told off for that.`,
      ``,
